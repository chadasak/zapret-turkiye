...
Kisa ozet
- wifi ayarlarindan dns ayarla, 1.1.1.1 kendi kisisel favorim
- Yonetici olarak ac.
...
# Kurulum
- hizmeti kurmadan once dns ayarlamayi unutmayin dns over https ayari extra guvenlik sagliyabilir.
